...
/**
 * The Class Cuadro. Esta clase sirve para crear cuadros con diseños definidos.
 */
public class Cuadro {
	
	/** The cara cuadro. Es el diseño del cuadro */
	//attributes
	...
	/**
	 * Gets the cara cuadro. obtiene el diseño del cuadro.
	 *
